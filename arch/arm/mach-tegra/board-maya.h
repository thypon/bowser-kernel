/*
 * arch/arm/mach-tegra/board-maya.h
 *
...
#ifndef _MACH_TEGRA_BOARD_MAYA_H
#define _MACH_TEGRA_BOARD_MAYA_H
...
int maya_regulator_init(void);
int maya_suspend_init(void);
int maya_sdhci_init(void);
int maya_pinmux_init(void);
int maya_sensors_init(void);
int maya_emc_init(void);
int maya_edp_init(void);
int maya_panel_init(void);
int maya_kbc_init(void);
int maya_pmon_init(void);
int maya_soctherm_init(void);
