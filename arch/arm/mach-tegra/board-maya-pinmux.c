/*
 * arch/arm/mach-tegra/board-maya-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config maya_drive_pinmux[] = {
...
static __initdata struct tegra_pingroup_config maya_pinmux_set_nontristate[] = {
...
#include "board-maya-pinmux-t11x.h"
...
int __init maya_pinmux_init(void)
{
	tegra_pinmux_config_table(maya_pinmux_set_nontristate,
					ARRAY_SIZE(maya_pinmux_set_nontristate));
	maya_gpio_init_configure();

	tegra_pinmux_config_table(maya_pinmux_common, ARRAY_SIZE(maya_pinmux_common));
	tegra_drive_pinmux_config_table(maya_drive_pinmux,
					ARRAY_SIZE(maya_drive_pinmux));
