/*
 * arch/arm/mach-tegra/board-maya-pinmux-t11x.h
 *
...
static __initdata struct tegra_pingroup_config maya_pinmux_common[] = {
...
//	DEFAULT_PINMUX(ULPI_DATA0,    ULPI,        NORMAL,    NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(ULPI_DATA6,    ULPI,        PULL_UP,    NORMAL,   INPUT),
...
//	DEFAULT_PINMUX(ULPI_STP,      ULPI,        NORMAL,    NORMAL,   OUTPUT),
	...
	DEFAULT_PINMUX(GPIO_PV0,      RSVD,	  PULL_DOWN,    NORMAL,    OUTPUT),
...
static struct gpio_init_pin_info init_gpio_mode_maya_common[] = {
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PQ5, false, 1),
	...
	GPIO_INIT_PIN_MODE(TEGRA_GPIO_PO6, false, 1),
};
