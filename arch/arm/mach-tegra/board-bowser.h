/*
 * arch/arm/mach-tegra/board-bowser.h
 *
...
#define _MACH_TEGRA_BOARD_BOWSER_H
...
#define TEGRA_GPIO_LOUT_EN		TEGRA_GPIO_PR6
...
#define FRONT_CAM_RSTN			TEGRA_GPIO_PBB6
...
int bowser_regulator_init(void);
int bowser_suspend_init(void);
int bowser_sdhci_init(void);
int bowser_pinmux_init(void);
int bowser_sensors_init(void);
int bowser_emc_init(void);
int bowser_edp_init(void);
int bowser_panel_init(void);
int bowser_kbc_init(void);
int bowser_pmon_init(void);
int bowser_soctherm_init(void);
