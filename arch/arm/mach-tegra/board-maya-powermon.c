/*
 * arch/arm/mach-tegra/board-maya-powermon.c
 *
...
#define PRECISION_MULTIPLIER_MAYA 1000
...
static struct ina219_platform_data power_mon_info[] = {
	[VDD_12V_DCIN_RS] = {
		...
		.power_lsb = 1.8311874106 * PRECISION_MULTIPLIER_MAYA,
		.rail_name = "VDD_12V_DCIN_RS",
		.divisor = 20,
		.precision_multiplier = PRECISION_MULTIPLIER_MAYA,
		.cont_conf = 0x3FFF,
		.trig_conf = 0x1DB,
		.shunt_resistor = 10,
	},
	...
	[VDD_AC_BAT_VIN1] = {
		...
		.power_lsb = 1.2500381481 * PRECISION_MULTIPLIER_MAYA,
	...
	[VDD_5V0_SYS] = {
		.calibration_data  = 0xfffe,
		.power_lsb = 2.5000762963 * PRECISION_MULTIPLIER_MAYA,
	...
	[VDD_AC_BAT_D1] = {
		...
		.power_lsb = 2.563685298 * PRECISION_MULTIPLIER_MAYA,
...
static struct i2c_board_info maya_i2c0_ina219_board_info[] = {
	[INA_I2C_ADDR_40] = {
...
int __init maya_pmon_init(void)
{
	i2c_register_board_info(1, maya_i2c0_ina219_board_info,
		ARRAY_SIZE(maya_i2c0_ina219_board_info));
