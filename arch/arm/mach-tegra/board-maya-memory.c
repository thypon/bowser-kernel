...
static struct tegra11_emc_table Maya_dvfs_table_Elpida_0910_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
...
static struct tegra11_emc_table Maya_dvfs_table_Hynix_adie_0607_table[] = {
	{
		0x42,       /* Rev 4.0.3 */
		12750,      /* SDRAM frequency */
		900,        /* min voltage */
...
static struct tegra11_emc_pdata Maya_dvfs_table_Elpida_0910_pdata = {
	.description = "Maya_dvfs_table_Elpida_0910",
	.tables = Maya_dvfs_table_Elpida_0910_table,
	.num_tables = ARRAY_SIZE(Maya_dvfs_table_Elpida_0910_table),
};

static struct tegra11_emc_pdata Maya_dvfs_table_Hynix_adie_0607_pdata = {
	.description = "Maya_dvfs_table_Hynix_adie_0607",
	.tables = Maya_dvfs_table_Hynix_adie_0607_table,
	.num_tables = ARRAY_SIZE(Maya_dvfs_table_Hynix_adie_0607_table),
};

static struct tegra11_emc_pdata *maya_get_emc_data(void)
{
	if (tegra_bct_strapping == 0) {
	    //Load Hynix M-Die DVFS table
	    ...
	    pr_info("DVFS table : Elpida\n");
	    return &Maya_dvfs_table_Elpida_0910_pdata;
	} else if (tegra_bct_strapping == 3) {
	    //Load Hynix A-Die DVFS table
	    pr_info("DVFS table : Hynix A-Die\n");
	    return &Maya_dvfs_table_Hynix_adie_0607_pdata;
	} else {
...
int __init maya_emc_init(void)
{
	tegra_emc_device.dev.platform_data = maya_get_emc_data();
