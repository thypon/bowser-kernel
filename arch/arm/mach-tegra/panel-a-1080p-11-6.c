...
static int bowser_dsi_regulator_get(struct device *dev)
#elif defined(CONFIG_MACH_MAYA)
...
#ifdef CONFIG_MACH_BOWSER
static int bowser_dsi_gpio_get(void)
#elif defined(CONFIG_MACH_MAYA)
...
#ifdef CONFIG_MACH_BOWSER
	err = bowser_dsi_regulator_get(dev);
#elif defined(CONFIG_MACH_MAYA)
...
#ifdef CONFIG_MACH_BOWSER
	struct platform_device *bowser_display_device)
#elif defined(CONFIG_MACH_MAYA)
...
{
#ifdef CONFIG_MACH_BOWSER
	disp_device = bowser_display_device;
#elif defined(CONFIG_MACH_MAYA)
...
#ifdef CONFIG_MACH_BOWSER
static struct i2c_board_info bowser_tc358770_dsi2edp_board_info __initdata = {
#elif defined(CONFIG_MACH_MAYA)
static struct i2c_board_info maya_tc358770_dsi2edp_board_info __initdata = {
#else
...
#ifdef CONFIG_MACH_BOWSER
			&bowser_tc358770_dsi2edp_board_info, 1);
#elif defined(CONFIG_MACH_MAYA)
			&maya_tc358770_dsi2edp_board_info, 1);
#else
