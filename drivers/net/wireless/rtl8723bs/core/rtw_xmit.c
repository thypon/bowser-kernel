...
static void update_attrib_phy_info(PADAPTER padapter, struct pkt_attrib *pattrib, struct sta_info *psta)
{
	...
	if (padapter->mlmeextpriv.cur_bwmode < psta->bw_mode)
		pattrib->bwmode = padapter->mlmeextpriv.cur_bwmode;
	else
