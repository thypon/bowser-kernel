...
int rtw_set_country(_adapter *adapter, const char *country_code)
{
	...
	else if(0 == strcmp(country_code, "BOWSER_FCC1"))
		channel_plan = RT_CHANNEL_DOMAIN_FCC1_NULL;
	else if(0 == strcmp(country_code, "BOWSER_WORLD"))
		channel_plan = RT_CHANNEL_DOMAIN_WORLD_NULL;
	else if(0 == strcmp(country_code, "BOWSER_MKK1"))
		channel_plan = RT_CHANNEL_DOMAIN_MKK1_NULL;
	else
