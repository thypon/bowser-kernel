...
struct inv_mpu_slave {
	...
	int (*bypass_read)(struct inv_gyro_state_s *st, unsigned char *data);
};
/* AKM definitions */
...
#define REG_WHOAMI_3050         (0x00)
#define REG_WHOAMI              (0x75)
#define WHOAMI_MASK             (~0x81)
...
#define BIT_MOTION_EN           (0x40)
#define BIT_ZERO_MOTION_EN      (0x20)
...
#define MAX_GYRO_FS_PARAM           (NUM_FSR-1)// 3
#define MAX_ACCL_FS_PARAM           (NUM_ACCL_FSR-1)// 3
...
/*---- MPU3050/6050 ----*/
#define MPU3050_6050_ID                 0x68      /* unique WHOAMI */
...
int inv_self_test_mpu3050(struct inv_gyro_state_s *st, int *gyro_bias_regular);
int inv_hw_self_test(struct inv_gyro_state_s *st, int *gyro_bias_regular);
int inv_hw_self_test_6500(struct inv_gyro_state_s *st, int *gyro_bias_regular);
