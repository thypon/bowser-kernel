...
struct rmi_f12_general_info {
	...
	u8 has_closed_cover:1;
	u8 has_fast_glove_detect:1;
	u8 has_dribble:1;
	u8 reserved:4;
...
struct f12_ctl_reporting_control {
        u8 *buffer;
        u8 *x_suppress;
        u8 *y_suppress;
        u8 *report_flags;
...
#define F12_FINGER_ACM_REG 5
#define F12_SENSOR_TUNING_REG 8
#define F12_COORD_MAX_SP 0
#define F12_REPORTING_CONTROL_REG 20
...
struct f12_data {
	...
	struct f12_ctl_reporting_control reporting_control;
